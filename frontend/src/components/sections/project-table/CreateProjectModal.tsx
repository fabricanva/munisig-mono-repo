...
const CreateProjectModal = ({ open, onClose, onSuccess }: CreateProjectModalProps) => {
    ...
    useEffect(() => {
        ...
        const fetchPersonnel = async () => {
            try {
                ...
                // Flatten to personnel list (users that have personnel linked)
    ...
    const handleMembersChange = (e: any) => {
        ...
        setForm((prev) => ({ ...prev, memberPersonnelIds: value }));
    };
    ...
    const handleSubmit = async () => {
        try {
            ...
            const payload: any = {
                ...
                chiefPersonnelId: form.chiefPersonnelId ? parseInt(form.chiefPersonnelId) : undefined,
                memberPersonnelIds: form.memberPersonnelIds.length > 0 ? form.memberPersonnelIds : undefined,
            };
        ...
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent dividers sx={darkSx}>
                <Grid container spacing={2}>
                    <Grid size={12}>
                        <TextField name="name" label="Nombre*" fullWidth value={form.name} onChange={handleChange} />
                    </Grid>
                    <Grid size={12}>
